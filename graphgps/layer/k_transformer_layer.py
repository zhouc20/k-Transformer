...
class k_Transformer_Layer(nn.Module):
    """
        k-Transformer layer.
    """
    ...
    def __init__(self, dim_h,
                 ...
                 bigbird_cfg=None, exp_edges_cfg=None, log_attn_weights=False, focusing_factor=1):
        super().__init__()
    ...
    def forward(self, batch):
        ...
        h_out_list = []
        # Local MPNN with edge attributes - generally ignored.
        ...
        if self.global_model_type in ['ETransformer', 'Exphormer']:
            ...
            h_dense, mask = to_dense_batch(h, batch.batch_tuple)
