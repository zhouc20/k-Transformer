...
from graphgps.encoder.atom_bond_encoder import AtomEncoder_custom, BondEncoder_custom
...
from graphgps.encoder.signnet_pos_encoder import SignNetNodeEncoder, StableExpressivePENodeEncoder
...
ds_encs = {'Atom': AtomEncoder,
           'Atom_custom': AtomEncoder_custom,
...
pe_encs = {'LapPE': LapPENodeEncoder,
           ...
           'StableExpressivePE': StableExpressivePENodeEncoder}

ds_edge_encs = {'Bond': BondEncoder,
                'Bond_custom': BondEncoder_custom,
...
# Combine both StableExpressivePE and RWSE positional encodings.
for ds_enc_name, ds_enc_cls in ds_encs.items():
    register_node_encoder(
        f"{ds_enc_name}+StableExpressivePE+RWSE",
        concat_node_encoders([ds_enc_cls, StableExpressivePENodeEncoder, RWSENodeEncoder],
                             ['StableExpressivePE', 'RWSE'])
    )
